<template>
  <div class="terms-of-use" content>
    ...
    <p>
      ...
      received parental permission to use the Site; (5) you will not access the
    ...
    <ol>
      ...
      <li>
        ...
        otherwise harm, in our opinion, us and/or the Site. Use any information
        obtained from the Site in order to harass, abuse, or harm another
        person. Make improper use of our support services or submit false
        reports of abuse or misconduct. Use the Site in a manner inconsistent
        with any applicable laws or regulations. Use the Site to advertise or
        offer to sell goods and services. Upload or transmit (or attempt to
    ...
    <p>
      ...
      reviews should not contain references to illegal activity; (5) you should
      not be affiliated with competitors if posting negative reviews; (6) you
      should not make any conclusions as to the legality of conduct; (7) you may
      not post any false or misleading statements; and (8) you may not organize
    ...
    <p>
      ...
      SERVICE PROVIDERS. We make no effort to review any Social Network Content
    ...
    <p>
      ...
      in the United States. If you access the Site from any other region of the
      world with laws or other requirements governing personal data collection,
      use, or disclosure that differ from applicable laws in the United States,
      then through your continued use of the Site, you are transferring your
      data to the United States, and you agree to have your data transferred to
    ...
    <p>
      ...
      the protection provided to you by obligatory provisions of the law of your
      country of residence. Timo's Design and yourself both agree to submit to
      the non-exclusive jurisdiction of the courts of Baden-Württemberg, which
      means that you may make a claim to defend your consumer protection rights
      in regards to these Conditions of Use in Germany, or in the EU country in
      which you reside.
    </p>
    ...
    <p>
      ...
      acceptance. The seat of arbitration shall be Mannheim, Germany. The
      language of the proceedings shall be German. Applicable rules of
    ...
    <p>
      ...
      YOU TO US OR TIMO'S DESIGN. CERTAIN US STATE LAWS AND INTERNATIONAL LAWS
